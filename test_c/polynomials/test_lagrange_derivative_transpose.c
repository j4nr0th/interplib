...
int main()
{
    ...
    double work_buffer2[ROOT_COUNT];

    lagrange_polynomial_first_derivative(TEST_NODES, nodes, ROOT_COUNT, roots, values_normal, work_buffer,
                                         work_buffer2);
    lagrange_polynomial_first_derivative_transposed_2(TEST_NODES, nodes, ROOT_COUNT, roots, values_transposed);
