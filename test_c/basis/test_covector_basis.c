...
int main(void)
{
    ...
    // Basic checks in 3d
    {
        const basis basis_1 = covector_basis_make(3, 0, 1, 0);
        const basis basis_2 = covector_basis_make(3, 0, 1, 1);
        ...
        print_basis(&basis_3);
        printf("\n");
        const basis expected_basis_3 = covector_basis_make(3, 0, 2, 0, 1);
        ...
        print_basis(&basis_4);
        printf("\n");
        const basis expected_basis_4 = covector_basis_make(3, -1, 2, 0, 1);
        check_basis_equal(&basis_4, &expected_basis_4);
    }

    // Some more involved checks in 5d
    {
        const basis b0 = covector_basis_make(5, 0, 1, 0);
        const basis b1 = covector_basis_make(5, 0, 1, 1);
        const basis b4 = covector_basis_make(5, 0, 1, 4);

        // b1 ^ b4 ^ b0
        const basis b140 = covector_basis_wedge(covector_basis_wedge(b1, b4), b0);
        const basis expected_b140 = covector_basis_make(5, 0, 3, 0, 1, 4);
        printf("b1 ^ b4 ^ b0: ");
        print_basis(&b140);
        printf("\n");
        ...
        const basis expected_b410 = covector_basis_make(5, -1, 3, 0, 1, 4);
        printf("b4 ^ b1 ^ b0: ");
        print_basis(&b410);
        printf("\n");
    ...
    // Fun in 7d
    {
        ...
        const basis b13 = covector_basis_make(7, 0, 2, 1, 3);
        const basis b602 = covector_basis_make(7, 0, 3, 6, 0, 2);
        const basis expected_result = covector_basis_make(7, -1, 5, 0, 1, 2, 3, 6);
