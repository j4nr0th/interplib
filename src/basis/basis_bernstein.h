...
#ifndef INTERPLIB_BASIS_BERNSTEIN_H
#define INTERPLIB_BASIS_BERNSTEIN_H
#include "basis_set.h"

INTERPLIB_INTERNAL
void bernstein_basis_values(unsigned n_pts, const double INTERPLIB_ARRAY_ARG(nodes, n_pts), unsigned order,
